...
#ifndef NNTRAINER_DEEPSEEK_MOE_LAYER_SLIM_H
#define NNTRAINER_DEEPSEEK_MOE_LAYER_SLIM_H
...
namespace props {
/**
 * @brief Routed Scaling Factor
 *
 */
class RoutedScalingFactor : public nntrainer::Property<float> {
public:
  static constexpr const char *key = "routed_scaling_factor";
 ...
 */
class DeepseekSlimMoELayer : public nntrainer::LayerImpl {
public:
  /**
   * @brief     Constructor of Mixture of Expert Layer
   */
  DeepseekSlimMoELayer();

  /**
   * @brief     Destructor of Mixture of Expert Layer
   */
  ~DeepseekSlimMoELayer() = default;

  /**
   * @brief  Move constructor.
   *  @param[in] ErnieMoELayer &&
   */
  DeepseekSlimMoELayer(DeepseekSlimMoELayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @param[in] rhs ErnieMoELayer to be moved.
   */
  DeepseekSlimMoELayer &operator=(DeepseekSlimMoELayer &&rhs) = default;
   ...
   */
  const std::string getType() const override { return DeepseekSlimMoELayer::type; };
  ...
  static constexpr const char *type = "deepseek_moe_slim"; /**< type of the layer */
...
private:
  ...
  std::tuple<props::NumExperts, props::NumExpertsPerToken,
             ...
             props::NormTopKProb, props::RoutedScalingFactor>
    moe_props;
...
#endif // NNTRAINER_DEEPSEEK_MOE_LAYER_SLIM_H
