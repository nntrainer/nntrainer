...
#ifndef NNTRAINER_DEEPSEEK_MOE_LAYER_H
#define NNTRAINER_DEEPSEEK_MOE_LAYER_H
 ...
 */
class DeepseekMoELayer : public nntrainer::LayerImpl {
public:
  /**
   ...
   */
  ~DeepseekMoELayer() = default;

  /**
   * @brief  Move constructor.
   *  @param[in] ErnieMoELayer &&
   */
  DeepseekMoELayer(DeepseekMoELayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @param[in] rhs ErnieMoELayer to be moved.
   */
  DeepseekMoELayer &operator=(DeepseekMoELayer &&rhs) = default;
...
#endif // NNTRAINER_DEEPSEEK_MOE_LAYER_H
