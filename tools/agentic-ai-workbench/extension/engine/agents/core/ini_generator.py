...
def run(state: dict) -> dict:
    ...
    # NOTE: Previously skipped .ini for causallm_component, but .ini is useful
    # for debugging/inspection even for CausalLM models. Generate it regardless.
    # The CausalLM C++ class builds the model programmatically, but .ini serves
    # as a reference graph description for debugging.
