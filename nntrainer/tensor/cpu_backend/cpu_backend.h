 ...
 * @param alpha float
 */
extern void swiglu_unrolledx2(const unsigned int N, float *X, float *Y, float *Z, float alpha);
 ...
 * @param alpha float
 */
extern void swiglu_unrolledx4(const unsigned int N, float *X, float *Y, float *Z, float alpha);
...
extern void tanh_gelu_unrolledx2(const unsigned int N, const float *X, float *Y);
...
extern void tanh_gelu_unrolledx4(const unsigned int N, const float *X, float *Y);
...
extern void tanh_gelu_v2_unrolledx2(const unsigned int N, const float *X, float *Y);
...
extern void tanh_gelu_v2_unrolledx4(const unsigned int N, const float *X, float *Y);
...
extern void tanh_gelu_v3_unrolledx2(const unsigned int N, const float *X, float *Y);
...
extern void tanh_gelu_v3_unrolledx4(const unsigned int N, const float *X, float *Y);
...
extern void tanh_gelu_v2_mul(const unsigned int N, float *X, float *Y, float *Z);
...
extern void tanh_gelu_v2_mul_unrolledx2(const unsigned int N, float *X, float *Y, float *Z);
...
extern void tanh_gelu_v2_mul_unrolledx4(const unsigned int N, float *X, float *Y, float *Z);
...
extern void tanh_gelu_v3_mul(const unsigned int N, float *X, float *Y, float *Z);
