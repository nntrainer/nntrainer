...
// NBATCH_FA for FP32 Adreno prefill
// NBATCH_FA=32 causes CL_OUT_OF_HOST_MEMORY on some Adreno compilers
// NBATCH_FA=16 reduces local memory from ~37.5KB to ~21.5KB and compiles reliably
#ifndef NBATCH_FA
#define NBATCH_FA 16
#endif
