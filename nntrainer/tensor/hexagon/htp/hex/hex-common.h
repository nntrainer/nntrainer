 ...
 * Local modification: identifiers renamed to the hex_ prefix (hmx_ceil_div ->
 * hex_ceil_div).
 */
#ifndef HEX_COMMON_H
#define HEX_COMMON_H
...
static inline int32_t hex_is_one_chunk(void *addr, uint32_t n,
                                       uint32_t chunk_size) {
...
static inline size_t hex_smin(size_t a, size_t b) { return a < b ? a : b; }

static inline size_t hex_smax(size_t a, size_t b) { return a > b ? a : b; }
