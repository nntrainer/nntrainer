...
size_t dma_queue_alignof(void) { return HEX_L2_LINE_SIZE; }
...
void dma_queue_free(dma_queue_t q) { (void)q; }

size_t dma_queue_alias_sizeof(void) { return sizeof(dma_queue); }
...
void dma_queue_alias_free(dma_queue_t q) { (void)q; }
