...
#define CUDA_CHECK(status) nntrainer::cuda::cuda_check_error(status, __FILE__, __LINE__)
#define CU_CHECK(status) nntrainer::cuda::cu_check_error(status, __FILE__, __LINE__)
